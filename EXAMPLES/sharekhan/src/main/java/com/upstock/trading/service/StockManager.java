...
public interface StockManager {
     ...
     * @param parameters
     * @return
     *     returns com.upstock.trading.types.Receipt
     */
    @WebMethod(action = "http://upstock.com/trading/service/buyStock")
    @WebResult(name = "receipt", targetNamespace = "http://upstock.com/trading/types", partName = "parameters")
    ...
    public Receipt buyStock(
        @WebParam(name = "buyQuote", targetNamespace = "http://upstock.com/trading/types", partName = "parameters")
        BuyQuote parameters);
