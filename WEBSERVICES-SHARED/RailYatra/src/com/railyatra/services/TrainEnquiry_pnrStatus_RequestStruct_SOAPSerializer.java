...
public class TrainEnquiry_pnrStatus_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public TrainEnquiry_pnrStatus_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.railyatra.services.TrainEnquiry_pnrStatus_RequestStruct instance = new com.railyatra.services.TrainEnquiry_pnrStatus_RequestStruct();
        com.railyatra.services.TrainEnquiry_pnrStatus_RequestStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_String_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.railyatra.services.TrainEnquiry_pnrStatus_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.railyatra.services.TrainEnquiry_pnrStatus_RequestStruct instance = (com.railyatra.services.TrainEnquiry_pnrStatus_RequestStruct)obj;
