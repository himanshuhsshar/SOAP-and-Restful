...
public class TrainEnquiry_pnrStatus_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public TrainEnquiry_pnrStatus_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.railyatra.services.TrainEnquiry_pnrStatus_ResponseStruct instance = new com.railyatra.services.TrainEnquiry_pnrStatus_ResponseStruct();
        com.railyatra.services.TrainEnquiry_pnrStatus_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_result_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.railyatra.services.TrainEnquiry_pnrStatus_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.railyatra.services.TrainEnquiry_pnrStatus_ResponseStruct instance = (com.railyatra.services.TrainEnquiry_pnrStatus_ResponseStruct)obj;
