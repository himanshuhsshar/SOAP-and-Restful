...
@XmlType(name = "", propOrder = { "passengers", "journeyInfo" })
...
public class TravelPlan {
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Passenger }
	 * 
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link TravelPlan.JourneyInfo }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link TravelPlan.JourneyInfo }
	 * 
	 */
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "flightNo", "source", "destination", "journeyDt", "mobileNo", "emailAddress" })
